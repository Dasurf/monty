...
/**
 * struct staq - doubly linked list representation of a stack (or queue)
 * @num: the integer
 ...
 * for stack, queues, LIFO, FIFO Holberton/ALX project
 */
typedef struct staq
{
	int num;
...
void ds_nop(stack_t **head, unsigned int count);
...
void ds_rotl(stack_t **head, unsigned int count);
